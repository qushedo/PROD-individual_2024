...
const busesLink = "https://travel.yandex.ru/buses/"

func GetBusLink(from models.Location, to models.Location, when time.Time) (string, error) {
	...
	urlTrains := busesLink + addressFromCity + "--" + addressToCity + "/?date=" + dateWhen
	return urlTrains, nil
}

func GetBusLinkByCords(fromLat float64, fromLng float64, toLat float64, toLng float64, when time.Time) (string, error) {
